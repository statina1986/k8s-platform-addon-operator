...
keycloakPlatform:
  ...
  # use limited admin for qinstaller. Requires QRP 2026.04 or later.
  limitedAdminEnabled: false
  # limited admin username, used in system-spec side qinstaller
  limitedAdminUsername: "limitedadmin"
  ...
  configurator:
    ...
    configmapValues:
      realms:
        # create bss realms here, as limited admin does not have permission to create new realms
        consumers:
          config:
            events:
        ...
        master:
          ...
          roles:
            limited:
              # admin to other realms than master. Exclude event config so limited admin can't remove/change event configuration.
              client_composite:
                consumers-realm:
            ...
            minimal:
              # this role exists to keep keycloak admin console working. without any permissions, the admin console gives an error.
              client_composite:
                master-realm:
                  - query-realms
            partners-useradmin:
          ...
          # limited admin user for system-spec-side configuration
          users:
            limitedadmin:
              roles:
                - limited
  ...
  deployment:
    ...
    healthPort: 9000
    image: ${keycloakRegistry}/qvaa-keycloak-qrp-postgres-quarkus:26.5.4.1.20260223090358_master_5d24b362
