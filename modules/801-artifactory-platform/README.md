...
<table>
	...
	<tbody>
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-jcr.artifactory.artifactory.admin</td>
		<td>object</td>
		<td>
...
Defines admin secrets.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-jcr.artifactory.artifactory.name</td>
		<td>string</td>
		<td>
...
'name' must be same with the 'fullnameOverride'.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-jcr.artifactory.database</td>
		<td>object</td>
		<td>
...
Kube secret name
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-jcr.artifactory.database.secrets</td>
		<td>object</td>
		<td>
...
Define DB secret names that are created by the deployment.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-jcr.artifactory.database.url</td>
		<td>string</td>
		<td>
...
Define existing postgredb cluster. CNPG module default cluster name used.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-jcr.artifactory.fullnameOverride</td>
		<td>string</td>
		<td>
<pre style="width:500px; overflow-x:auto; white-space: pre;" lang="yaml"><code>artifactory-jcr</code></pre>
</td>
...
'fullnameOverride' fully overrides the deployment name.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-jcr.artifactory.nginx</td>
		<td>object</td>
		<td>
...
Enable separate nginx container.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-jcr.artifactory.postgresql</td>
		<td>object</td>
		<td>
<pre style="width:500px; overflow-x:auto; white-space: pre;" lang="yaml"><code>enabled: false</code></pre>
</td>
...
Enable PostgreSQL dependency sub-chart. Not required in qvantel platform.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-jcr.artifactory.router</td>
		<td>object</td>
		<td>
...
Router microservice, discovers other artifactory microservices. See https://jfrog.com/help/r/artifactory-s-microservices-explained/router
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-jcr.enabled</td>
		<td>bool</td>
		<td>
...
Enable deployment of JCR Artifactory.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-oss.artifactory.artifactory.admin</td>
		<td>object</td>
		<td>
<pre style="width:500px; overflow-x:auto; white-space: pre;" lang="yaml"><code>dataKey: bootstrap.creds
...
Defines admin secrets.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-oss.artifactory.artifactory.admin.dataKey</td>
		<td>string</td>
		<td>
...
Key identifier set in the kube 'secret'
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-oss.artifactory.artifactory.admin.secret</td>
		<td>string</td>
		<td>
...
Kube secret name
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-oss.artifactory.artifactory.name</td>
		<td>string</td>
		<td>
...
'name' must be same with the 'fullnameOverride'.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-oss.artifactory.database</td>
		<td>object</td>
		<td>
<pre style="width:500px; overflow-x:auto; white-space: pre;" lang="yaml"><code>driver: org.postgresql.Driver
secrets:
...
Main DB configuration
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-oss.artifactory.database.secrets</td>
		<td>object</td>
		<td>
<pre style="width:500px; overflow-x:auto; white-space: pre;" lang="yaml"><code>password:
    key: password
...
Define DB secret names that are created by the deployment.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-oss.artifactory.database.url</td>
		<td>string</td>
		<td>
...
Define existing postgredb cluster. CNPG module default cluster name used.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-oss.artifactory.fullnameOverride</td>
		<td>string</td>
		<td>
<pre style="width:500px; overflow-x:auto; white-space: pre;" lang="yaml"><code>artifactory-oss</code></pre>
</td>
...
'fullnameOverride' fully overrides the deployment name.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-oss.artifactory.nginx</td>
		<td>object</td>
		<td>
<pre style="width:500px; overflow-x:auto; white-space: pre;" lang="yaml"><code>enabled: false</code></pre>
</td>
...
Enable separate nginx container.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-oss.artifactory.postgresql</td>
		<td>object</td>
		<td>
<pre style="width:500px; overflow-x:auto; white-space: pre;" lang="yaml"><code>enabled: false</code></pre>
</td>
...
Enable PostgreSQL dependency sub-chart. Not required in qvantel platform.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-oss.artifactory.router</td>
		<td>object</td>
		<td>
<pre style="width:500px; overflow-x:auto; white-space: pre;" lang="yaml"><code>image:
    registry: platform.artifactory.qvantel.net/k8s-platform-1-2-0
...
Router microservice, discovers other artifactory microservices. See https://jfrog.com/help/r/artifactory-s-microservices-explained/router
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.artifactory-oss.enabled</td>
		<td>bool</td>
		<td>
<pre style="width:500px; overflow-x:auto; white-space: pre;" lang="yaml"><code>false</code></pre>
</td>
...
Enable deployment of OSS Artifactory.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.databaseJCR.name</td>
		<td>string</td>
		<td>
...
PostgreSQL cluster name override.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.databaseOSS</td>
		<td>object</td>
		<td>
...
Qvantel CNPG module database override.
	...
	<tr>
		<td style="width: 300px;">artifactoryPlatform.databaseOSS.name</td>
		<td>string</td>
		<td>
<pre style="width:500px; overflow-x:auto; white-space: pre;" lang="yaml"><code>qvt-postgredb</code></pre>
</td>
