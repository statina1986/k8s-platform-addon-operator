lokiPlatform:
  loki:
    ...
    read:
      ...
      extraEnv:
      # Checks if the variable exists before going further in logic to avoid KeyError
        % if values.get('lokiPlatform', {}).get('loki', {}).get('objectStorageSecret', None) is not None:
