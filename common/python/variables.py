...
VAULT_RELEASE_NAME = environ.get(HELM_RELEASE_NAME_PREFIX + 'vault-platform')
VAULT_ADDR = environ.get('VAULT_ADDR', 'http://' + HELM_RELEASE_NAME_PREFIX + 'vault-platform.' + ADDON_OPERATOR_NAMESPACE + '.svc.cluster.local:8200')
